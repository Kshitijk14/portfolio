...
export const experienceDetails: Record<string, { 
    ...
    '3': {
        ...
        descriptions: [
            'worked on ML pipelines for a multilingual AI health assistant', 
            ...
            'led 8 developers to deploy the system, integrated logging, monitoring, & caching to debug failures', 
    ...
    '4': {
        ...
        descriptions: [
            'coded a scalable backend infra. for an ai/web3 marketplace for an incubation program.',
            'introduced monorepo structure using TurboRepo for better code management, upgradeability, & maintainability.',
            'implemented user authentication & authorization using Next-Auth, ensuring secure access to resources.',
            'developed RESTful APIs & WebSocket connections for real-time data exchange, enabling seamless user interactions.',
            'optimized db queries & indexing strategies, resulting in a 50% reduction in response time for data retrieval operations.',
            ...
            'introduced ai dev tools in the workflow, for automating code reviews, documentation, testing, & deployment processes.',
