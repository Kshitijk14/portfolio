...
import { researchPapers } from '../../content/writing';
            ...
            {researchPapers.map((paper) => (
                ...
                >
                    <div className="flex justify-between items-center mb-4">
                        <h4 className="text-gray-800 dark:text-gray-200 text-xl">{paper.title}</h4>
                        <a href={paper.readLink} target="_blank" className="text-blue-500 hover:text-gray-600 dark:hover:text-gray-400 text-sm sm:text-base">read</a>
                    </div>
